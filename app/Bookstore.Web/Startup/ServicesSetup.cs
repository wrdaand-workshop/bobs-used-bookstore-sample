...
namespace Bookstore.Web.Startup
{
    public static class ServicesSetup
    {
        ...
        private static string GetDatabaseConnectionString(ConfigurationManager configuration)
        {
            ...
            // secret in Secrets Manager that in turn contains the credentials of the PostgreSQL
            // database in Amazon RDS Aurora. The reason for the indirection is that a secret name
            // is suffixed automatically by the CDK with a random string. Using a fixed Parameter
            // Store value to point to the randomly-named secret insulates the application from
            // variability in the name of the secret.
